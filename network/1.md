...
peer chaincode instantiate -o orderer.sunmi.com:7050 -C businesschain -n Distributor_Shipper_Farmer -v 1 -c '{"Args":["init"]}' -P "AND('FarmerMSP.member', 'DistributorMSP.member', 'ShipperMSP.member')" --collections-config  /opt/gopath/src/github.com/chaincode/distributor-shipper-farmer/collections_config.json --tls --cafile $ORDERER_CA
...
peer chaincode query -C businesschain -n Distributor_Shipper_Farmer -c '{"Args":["getFruitTxByRange","0","1"]}'
...
peer chaincode query -C businesschain -n Distributor_Shipper_Farmer -c '{"Args":["readDeliverFeeTx","1"]}'
peer chaincode query -C businesschain -n Distributor_Shipper_Farmer -c '{"Args":["getDeliverFeeTxByRange","0","1"]}'
